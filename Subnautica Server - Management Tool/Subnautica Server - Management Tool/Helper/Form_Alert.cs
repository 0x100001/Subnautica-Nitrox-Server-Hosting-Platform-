...
namespace Subnautica_Server___Management_Tool.Helper
{
    public partial class Form_Alert : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                case enmAction.wait:
                    notification_timer.Interval = 5000;
                    action = enmAction.close;
                    break;
                case Form_Alert.enmAction.start:
                    this.notification_timer.Interval = 1;
                    this.Opacity += 0.1;
        ...
        public void showAlert(string msg, enmType type)
        {
            ...
            switch (type)
            {
                case enmType.Success:
                    ...
                    break;
                case enmType.Error:
                    this.BackColor = Color.FromArgb(176, 1, 18);
                    break;
                case enmType.Info:
